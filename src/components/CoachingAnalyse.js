...
function CoachingAnalyse() {
    ...
    const breadcrumbs = [
        ...
        <Typography key="3" color="text.primary" sx={{color:"#AB0C18"}}>
            Coaching en analyse d’affaires
        </Typography>,
      ];
  ...
  return (
    <Grid container direction="column" sx={{marginTop:"50px", display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: "100px"}}>
      <Box sx={{width: "45%"}}>
        <Typography variant="h6" sx={{fontWeight: "bold", color:"#AB0C18" }}>Coaching en analyse d’affaires</Typography>
...
export default CoachingAnalyse;